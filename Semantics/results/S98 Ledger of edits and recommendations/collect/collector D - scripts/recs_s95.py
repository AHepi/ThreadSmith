...
ITEMS = [
 ...
 ("RF", "section 8, belief words, R6 option B, the same pointer for 'recognized difficulty' at l. 223", 223, None, ("b", 'Option B: add "', '" at l. 221', '*Repair, R6, two options.*'), A, [39], "R6B-223", None, "span"),
 ...
 ("R1F", "Repairs, R6 option B (the same pointer for 'recognized difficulty' at its first use, l. 223)", 223, None, ("b", 'at the end of l. 221 add "', '", and give', '**R6 ('), A, [39], "R6B-223", None, "span"),
