...
Your job is to find what is wrong with the nine changes listed here. Those who drafted and checked them hold that every change does what its declaration says, that the WORDING and ORDER changes change no claim, and that the revised text is coherent. Test that as hard as you can, against the texts alone.

The revised text also makes forty-six other changes, which are examined separately and are not listed here. Read them as part of the revised text as it stands, and leave them out of your report, except where a listed change depends on one of them or pulls against it.
...
### R01 · Part 0, What this document claims, line 13
...
**Situations:** O11, N9, N11.

### R05 · Part 0, Where to attack this, line 61
...
### R08 · Part II, Kinds are edit-signatures, line 119
...
**Situations:** O9, O10, O22, N25.

### R09 · Part II, Kinds are edit-signatures, line 119
...
**Situations:** O10, O22, N16.

### R15 · Part V, Account, line 231
...
**Situations:** O2, O5, O7, O36, O45, O46, O47, N1.

### R16 · Part V, Non-circular dependence, line 255
...
**Situations:** O2, O4, N2, N3, N8, N25.

### R17 · Part V, Non-circular dependence, line 255
...
**Situations:** O2, O4, O5, O7, O33, O36, O45, O46, O47, N1, N3, N23, N25.

### R19 · Part V, What (E) excludes, and what it does not, line 273
...
### R20 · Part VI, Work, support, and interference, line 287
...
**Situation.** Ines says the ice on her step melted because she spread salt on it. Spread salt and the ice melts within the hour. Sweep the salt off at once and the ice stays. She has no account of what the salt does at any finer level, and no instrument is involved anywhere.

**Thoughtful person's verdict.** Ines has a genuine explanation, a coarse one. The salt is what produced the melting.

### O9 - The float that does two jobs

**Situation.** A float sits in a fuel tank. A rod from it turns a dial on the dashboard. The same float, when it drops low enough, pulls open a valve to the reserve tank. Milan says the falling float opens the valve. Lena says the dial reaching "low" opens it. Bend the needle to read "full": the float is where it was and the valve opens as before. Hold the float up with a wire: the dial reads "full" and the valve stays shut.

**Thoughtful person's verdict.** Milan is right, Lena is wrong. The float is read by the dial and also does the work.
...
**Situation.** Lea asks what happens when two knobs are turned together. On this machine the linkage lets one knob lead the other by a fraction of a second.

**Thoughtful person's verdict.** Her question is about the pair. The brief lead is part of what "together" means on this machine, and it is a fact about the machine, not a second question about one knob.
...
### O36 - A premise both routes use

**Situation.** Two proof routes reach the fixed answer. Both use premise P. Route two could be rewritten to use a different premise in P's place, but nobody has written that version.

**Thoughtful person's verdict.** P is critical in each route as written. That another route could be written without it is a fact about a candidate nobody has written.
...
**Situation.** A finite collection of commitments supports the conclusion, and every earlier addition to it kept the support. The newest addition, that the room was locked, conflicts with a premise every route uses.

**Thoughtful person's verdict.** The conclusion no longer follows. The collection stayed finite. What broke is that additions could not always be made without loss, and this one could not.
...
**Questions.** Leaving aside the birds' eyesight and any person who studies the moths: is there anything in the moths from which an observer could tell the colour of the bark in their district? If so, where is it, what holds it, and how did it get there?

**Thoughtful person's verdict.** Yes: the moths' wing colour, or more exactly the proportion of dark to pale moths in the district.
- **Where it shows.** In the wings of the district's moths taken together. One moth is weak evidence, since an odd pale moth can turn up on dark bark, but the population as a whole is a reliable guide.
- **What holds it.** What the moths inherit from their parents: the factors (genes) that set wing colour, now common or rare in each district. It lies in the population, not in any one moth.
- **How it got there.** By selection over many generations. Birds found and ate more of the moths that stood out, so moths that matched the bark lived to breed more often and passed their colouring on.

No moth knows the colour of the bark, and nobody put the match there. […]
...
**Situation.** A huge network of dominoes is built as a calculating machine. Each domino is spring-loaded: when knocked over, it knocks over its neighbour and then springs back up, so waves of falling dominoes travel along the network's branching and looping lines. This network is set up to test whether a number is prime. The number is fed in as a row of exactly that many dominoes, and one particular domino somewhere in the network falls only if the number turns out to have a divisor. The network is fed 641 and started. An observer who does not know what the network is for watches for hours and asks: "Why does that domino there never fall?" Answer A: that domino never falls because none of its neighbours ever falls at a moment that would knock it over, and so on back; in sum, none of the patterns of motion started by knocking over the first domino ever includes it. Answer B: "Because 641 is prime. The network tests whether its input is prime, and that domino falls only when a divisor is found." Both answers are true.

**Question.** Does each answer explain why that domino never falls?

**Thoughtful person's verdict.** B explains it. A, though true, does not really.
- **What A does.** It comes down to "it never falls because nothing ever knocks it over". It passes the question from each domino back to its neighbours and ends by saying that no wave ever reaches this one. The observer had already seen that; A restates it in terms of dominoes.
- **Why A falls short.** The same answer would do for any domino that stays up, and it does not say why no wave reaches this one.
- **What B does.** It says what is special about this domino and why no wave reaches it: the machine hunts for divisors, this domino falls only when one is found, and 641 has none. It also tells the observer what the network is for and what would change the result: feed in 640 and the domino falls.
