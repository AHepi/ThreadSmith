...
This text carries only **F2**; F1 and F3 are examined in separate texts. Your job is to test that claim as hard as you can against the theory's own text, and to judge the repair proposed for it.
...
The theory was condensed from an earlier, longer document. That document is not under audit. One of its passages is quoted here word for word because the finding refers to it: passage 1 is its statement of approximate transport, which contains its version of (T2).
