...
### R26 · Part VIII, Functional transport, line 349
...
### R27 · Part VIII, Approximate transport, line 359
...
**Situations:** O1, O42, O49, O52, N24.

### R43 · Part XIII, Barriers, line 489
...
### R51 · Part XVI, Derivation 2, lines 554–562
...
**Situations:** O10, O11, O18, O24, O36, O45, O46, N15, N17, N25.

### R54 · Part XVI, Derivation 10, line 620
...
### R55 · Part XVI, Derivation 10, line 624
...
These are the cases that the drafters named as at risk from the changes in section 3. A change may still move the verdict on a case not given here, and you may describe such a case yourself.
...
### O42 - New board, old memory

**Situation.** The robot's controller board fails mid-task. A technician fits a new board and copies the memory and routines across. The task finishes. At the start, continuity of memory and routines had been stated as what makes it the same robot.

**Thoughtful person's verdict.** The same robot finished, on the stated terms. The swap repaired the system; it did not substitute another one.

### O43 - Mirrored marks

**Situation.** Sam's diagram is translated into raised marks by a reader who writes right to left. Every pairing of tooth to obstruction is preserved, and the reader's convention is stated on the sheet.

**Thoughtful person's verdict.** The transfer preserved the content. The mirror is a convention, declared, and anyone reading with it recovers every pairing.
...
**Questions.** Can each method keep count of a flock of any size, through any number of such joinings and splittings? What, if anything, limits it?

**Thoughtful person's verdict.** Only the second method can.

**The first method fails as it grows.**
- Every measurement adds an error of up to a tenth of an inch: each goat out and back, each join, each cut. Nothing removes the error or lets the herders tell a slightly wrong length from a right one.
- With enough goats and operations, the accumulated error grows larger than a goat, and the string can no longer show whether a goat is missing.
- It also tracks the flock's total length rather than its number, and cutting a length string does not tell you which goats went where […].
- What limits it is the accumulated error, measured against a goat's length.

**The second method holds at any size.**
- Each error is well under half an inch, and rounding to the nearest inch wipes it out. Errors never build up, and the string stays exactly as many inches long as there are goats.
- Only practical things limit it: enough string, space and time.
- It relies on three conditions: no single error ever reaching half an inch, however long the string; the herders rounding after every step; and the herders not blundering.
