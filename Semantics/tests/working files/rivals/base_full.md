...
What a reader can now conclude that file 11 left unconcluded: Part VI now defines the reach of an organization as the set of jobs for which it is an account, fixed by the organization and the world and not by which jobs anyone has checked.
...
What a reader can now conclude that file 11 left unconcluded: Part VI now says that (E) has no condition that each commitment do work; that a commitment such that every support stays a support when it is added and when it is removed does no work by itself in the candidate, leaves the candidate's standing under (E) unchanged and is critical in no support; that when the commitments are infinitely many a block of such commitments can still be critical; and that how hard an account is to vary is a separate matter, shown by Pres, which grades nothing.

**R2-25.** Part VII, Explanations that remove structure, line 337.
...
**R2-26.** Part VIII, Functional transport, line 351.
...
**R2-27.** Part VIII, Approximate transport, line 361.
...
**R2-28.** Part IX, Bearing, line 373.
...
**R2-29.** Part IX, Bearing, line 379.
...
**R2-30.** Part X, Construction, line 401.
...
**R2-32.** Part X, Ownership, line 419.
...
**R2-33.** Part X, Ownership, line 419.
...
**R2-34.** Part X, Episodes, line 421.
...
**R2-37.** Part XI, Created explanatory knowledge, line 445.
...
**R2-38.** Part XI, Worth, and the normative relation, line 447.
...
**R2-39.** Part XI, Worth, and the normative relation, line 447.
...
**R2-40.** Part XII, System boundary and continuity, line 465.
...
**R2-41.** Part XII, Grades, line 471.
...
**R2-42.** Part XII, Selection in the physical module, line 473.
...
**R2-43.** Part XIII, Barriers, line 487.
...
**R2-44.** Part XIV, Primitives, line 512.
...
**R2-45.** Part XIV, Declared inputs, line 514.
...
**R2-46.** Part XIV, Indices, not primitives, line 516.
...
**R2-47.** Part XIV, Dependence order, line 518.
...
**R2-48.** Part XIV, Dependence order, line 518.
...
**R2-49.** Part XV, What defeats this class, line 526.
...
**R2-50.** Part XV, (A) Sufficiency, line 528.
...
**R2-51.** Part XVI, Derivation 2, lines 552–558.
...
**R2-52.** Part XVI, Derivation 3, Claim, line 562.
...
**R2-53.** Part XVI, Derivation 6, Proof, line 588.
...
**R2-54.** Part XVI, Derivation 10, line 616.
...
**R2-55.** Part XVI, Derivation 10, line 620.
...
| L2-26 | Part X, Ownership | none | L419 | Ownership of Build's subhistory is defined: its processes run inside the system boundary and resource contract declared for the system. Work supplied from outside that boundary remains an outside contribution however it is executed inside; a process that runs inside the boundary is the system's own today whoever wrote it; where the boundary is drawn decides, not where the process sits; and ownership is not defined by the capability it grounds. File 10 used "owned" without defining it. | changed by R2-32 and R2-33 |
| L2-27 | Part XI, Repair | L438–L444 | L433, sentence 1 | The obligations of a repair are declared inputs, each a stated condition over stated occasions, and a protected condition is lost exactly when it fails on an occasion it covers; file 10 checked a protected condition at the two ends of the comparison and named no occasions. | kept; R2-36 adds text beside it |
...
| L2-37 | Part XIV, Declared inputs | none; compare L521–L523 | L514 | Some claims take stated inputs that the semantics records and does not supply: the obligations of a repair with the occasions each covers, the scope of a contract and what makes a restriction appropriate, and the boundary and continuity of an attribution. A verdict that depends on one is a verdict given the input, and where the input is missing the verdict is unsettled. | changed by R2-45 |
