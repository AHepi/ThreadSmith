...
for f in T10D_new_unlisted T10D_new_addfinding T10D_new_dropped T10D_after_gauge T10B_after_gauge T10B_new_nofix P14_new_nofix N18A_new_nofix T07D_new_wrongfact T07D_new_wrongline; do o=$(echo $f | cut -d_ -f1)_old.txt; expect $o $f.txt FAILS; done
