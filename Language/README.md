...
- **Next step (from the log):** give 38 and 39 to the other model with one text from its own corpus and compare ledgers line by line.
...
tests/         frozen plans: 21 Markus, 22 Mondays, 35 the third pile, 37 the blind sample
results/       21 and 22 (html pages), 37 (md): what happened, with predictions ticked
