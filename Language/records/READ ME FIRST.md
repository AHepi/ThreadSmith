...
## Read in this order
1. This file.
2. **Language - project story.md**: the log for this thread, with "What each patch gave up" and the next step.
3. **Language - Status.md**: the short summary.
4. The frozen plan in `tests/45 ...` and the two packages in `results/`.
