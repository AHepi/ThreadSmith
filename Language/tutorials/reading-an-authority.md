...
## Tiny demonstration
Open [38 The ledger language - complete definition.md](<../authority/38 The ledger language - complete definition.md>). The first lines say what it is for and name the three roles that stay apart: translator, checker, read-back. There is no history in it; log 36 records that it was "checked by program for leftover history: none". That is what a clean authority looks like: one file, one version, nothing to reconcile.
