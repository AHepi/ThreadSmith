...
- **The theory is now file 11** (revision 1, Semantics decision S8, log S76; handed to this project by decision W2 and merged in from `main`), read beside file 10: [W4 Addendum (draft)](<tests/W4 Addendum to W3 - the theory is now file 11; what changes in the plan, and what it gives up (draft).md>) says what changes (M2 under the qualified Derivation 3; nine new sentences that hold parts W3 had built) and what is given up. File 11 is under test in the Semantics project's round S76 and not yet confirmed there; every row of phase 1's word list will say whether it rests on 10 and 11 or on 11 only.
