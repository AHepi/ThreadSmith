...
- **Never a Fable 5.1 reader under test. Never a Fable 5.1 or Opus 5 subagent without the owner's explicit permission** (decision H4). Readers so far: DeepSeek V4.1 Flash; Claude Sonnet 5 from plan H56 (decision H3).
