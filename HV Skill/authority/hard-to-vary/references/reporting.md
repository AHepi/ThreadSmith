...
| Held if | Removing it breaks only a job that is itself in doubt | which job, and what would settle it |
...
| Fixed | The owner set it as a requirement and it was not tested | that it was not tested |
